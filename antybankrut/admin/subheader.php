...
<table>
<tr>
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="../" style="text-decoration:none;font-size:12px;"><img src="style/images/website.png" title="Przejdz do strony glownej"><br>Portal</a></td>
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=news" style="text-decoration:none;font-size:12px;"><img src="style/images/news48.png"><br>News</a></td>
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=artykuly" style="text-decoration:none;font-size:12px;"><img src="style/images/a48.png"><br>Ogłoszenia</a></td>
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=cat" style="text-decoration:none;font-size:12px;"><img src="style/images/add48.png"><br>Kategorie</a></td>
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=faq" style="text-decoration:none;font-size:12px;"><img src="style/images/faq48.png"><br>FAQ</a></td>
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=zgloszenia" style="text-decoration:none;font-size:12px;"><img src="style/images/reuser48.png"><br>Zgłoszenia</a></td>
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=strony" style="text-decoration:none;font-size:12px;"><img src="style/images/p48.png"><br>Strony</a></td>
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=komentarze" style="text-decoration:none;font-size:12px;"><img src="style/images/kom48.png"><br>Komentarze</a></td>
...
<td style="border: 1px solid rgb(204, 204, 204);width:80px;" class="td_hover" align="center" valign="top"><a href="index.php?page=menu" style="text-decoration:none;font-size:12px;"><img src="style/images/m48.png"><br>Menu</a></td>
...
if($_GET['page']=="cat"){echo'<b style="color:white;">Ogłoszenia: Kategorie</b>';}
